...
class CardCarousel extends DraggingEvent {
  constructor(container, controller = undefined) {
    ...
    // A largura do card agora é fixa, então o cálculo percentual é simplificado.
    this.cardWidth =
  ...
  updateCardWidth() {
    // Recalcula a largura em porcentagem ao redimensionar a janela
    this.cardWidth =
      (this.cards[0].offsetWidth / this.container.offsetWidth) * 100;
  ...
  calcScale(x) {
    const formula = 1 - (1 / 32) * Math.pow(x, 4);
