...
function solicitarExclusao() {
  if (confirm("Tem certeza que deseja solicitar a exclusão desta vaga?")) {

    // Zera os campos
    document.getElementById("localVaga").value = "";
    document.getElementById("horaInicio").value = "";
    document.getElementById("horaFim").value = "";
    document.getElementById("datasVagaInicio").value = "";
    document.getElementById("datasVagaFim").value = "";
    document.getElementById("idNumVaga").value = "";

    alert("Solicitação enviada! Os campos foram limpos.");
  }
}
