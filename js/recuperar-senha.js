...
function carregarCadastros() {
  ...
  cadastroAtual = mockRecuperar.find((c) => c.id == cadastroId);
}
...
function salvarCadastro() {
  ...
  cadastroAtual.novasenha = document.getElementById("novaSenha").value;
  
  // Salvar no localStorage para simular persistência
  localStorage.setItem("cadastrousuarios", JSON.stringify(mockRecuperar));

  alert("✅ Nova senha aceita!");
